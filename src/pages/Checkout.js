...
function Checkout() {
    return (  
        ...
        <form className='bg-zinc-200 px-6 py-5 mt-12'>
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <p class="mt-1 text-sm leading-6 text-gray-600">Choose from Existing Addresses</p>
      ...
      {addresses.map((address) => (
        ...
        className="flex justify-between gap-x-6 px-5 py-5 border-solid border-3 border-gray-200 ">
          ...
          <input  name="address" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
        ...
        <fieldset>
          ...
          <div class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-x-3">
              ...
              <label for="card" class="block text-sm font-medium leading-6 text-gray-900">Card payments</label>
            </div>
...
<h1 className="text-4xl font-bold tracking-tight my-5 mx-5 text-gray-900">Cart</h1>
